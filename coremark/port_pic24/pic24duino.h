...
// - v3.3, 10/22/2022: introduced hardware (i2c1 and i2c2) and software i2c (sI2C)
// - v3.3a,11/13/2022: using analogRead to generate random numbers
// - v3.3b,11/25/2022: added circular buffer
//
//
//               PIC24FJ
//              |=====================|
...
//pic24GA11x family
#elif 	defined(__PIC24FJ64GA106__) | defined(__PIC24FJ128GA106__) | defined (__PIC24FJ192GA106__) | defined(__PIC24FJ256GA106__) | \
		defined(__PIC24FJ64GA108__) | defined(__PIC24FJ128GA108__) | defined (__PIC24FJ192GA108__) | defined(__PIC24FJ256GA108__) | \
		defined(__PIC24FJ64GA110__) | defined(__PIC24FJ128GA110__) | defined (__PIC24FJ192GA110__) | defined(__PIC24FJ256GA110__)

#define __PIC24GA11x__

//pic24GB11x family
#elif 	defined(__PIC24FJ64GB106__) | defined(__PIC24FJ128GB106__) | defined (__PIC24FJ192GB106__) | defined(__PIC24FJ256GB106__) | \
		defined(__PIC24FJ64GB108__) | defined(__PIC24FJ128GB108__) | defined (__PIC24FJ192GB108__) | defined(__PIC24FJ256GB108__) | \
		defined(__PIC24FJ64GB110__) | defined(__PIC24FJ128GB110__) | defined (__PIC24FJ192GB110__) | defined(__PIC24FJ256GB110__)

#define __PIC24GB11x__

#else
#error "PIC24Duino.h: PIC24 not supported!"
#endif		//chips
...
//#define UART1_TXISR							//uncomment for polling transmission
//#define UART2_TXISR							//uncomment for polling transmission
...
#define UxIP_DEFAULT		3				//default priority for uart isr
...
#define SystemCoreClockFRCPLL()			do {SystemCoreClockSwitch(0b001);} while (0)
#define SystemCoreClockFRCPLL4x()		SystemCoreClockFRCPLL()
#define SystemCoreClockPOSC()			do {SystemCoreClockSwitch(0b010);} while (0)
#define SystemCoreClockPOSCPLL()		do {SystemCoreClockSwitch(0b011);} while (0)
#define SystemCoreClockPOSCPLL4x()		SystemCoreClockPOSCPLL()
...
#define uart1Putch(ch)		do {uart1Wait(); U1TXREG = (ch);} while (0)
...
#define uart1Busy()			(IEC0bits.U1TXIE)
#else
...
#define uart2Busy()			(IEC1bits.U2TXIE)	//(!U2STAbits.TRMT)	//
#else
...
#else
#define pwm1SetDC(dc)		do {OC1R = (dc);} while (0)
#define pwm1GetDC()			(OC1R)
#define pwm1SetPR(pr)		do {if (OC1CON1bits.OCTSEL) OC1RS = PR3 = (pr) - 1; else OC1RS = PR2 = (pr) - 1;} while (0)
#define pwm1GetPR()			((OC1CON1bits.OCTSEL)?tmr3GetPR():tmr2GetPR())
#define pwm1SetPS(ps)		((OC1CON1bits.OCTSEL)?tmr3SetPS(ps):tmr2SetPS(ps))
#define pwm1GetPS()			((OC1CON1bits.OCTSEL)?tmr3GetPS():tmr2GetPS())
#endif
...
#else
#define pwm2SetDC(dc)		do {OC2R = (dc);} while (0)
#define pwm2GetDC()			(OC2R)
#define pwm2SetPR(pr)		do {if (OC2CON1bits.OCTSEL) OC2RS = PR3 = (pr) - 1; else OC2RS = PR2 = (pr) - 1;} while (0)
#define pwm2GetPR()			((OC2CON1bits.OCTSEL)?tmr3GetPR():tmr2GetPR())
#define pwm2SetPS(ps)		((OC2CON1bits.OCTSEL)?tmr3SetPS(ps):tmr2SetPS(ps))
#define pwm2GetPS()			((OC2CON1bits.OCTSEL)?tmr3GetPS():tmr2GetPS())
#endif
...
#else
#define pwm3SetDC(dc)		do {OC3R = (dc);} while (0)
#define pwm3GetDC()			(OC3R)
#define pwm3SetPR(pr)		do {if (OC3CON1bits.OCTSEL) OC3RS = PR3 = (pr) - 1; else OC3RS = PR2 = (pr) - 1;} while (0)
#define pwm3GetPR()			((OC3CON1bits.OCTSEL)?tmr3GetPR():tmr2GetPR())
#define pwm3SetPS(ps)		((OC3CON1bits.OCTSEL)?tmr3SetPS(ps):tmr2SetPS(ps))
#define pwm3GetPS()			((OC3CON1bits.OCTSEL)?tmr3GetPS():tmr2GetPS())
#endif
...
#else
#define pwm4SetDC(dc)		do {OC4R = (dc);} while (0)
#define pwm4GetDC()			(OC4R)
#define pwm4SetPR(pr)		do {if (OC4CON1bits.OCTSEL) OC4RS = PR3 = (pr) - 1; else OC4RS = PR2 = (pr) - 1;} while (0)
#define pwm4GetPR()			((OC4CON1bits.OCTSEL)?tmr3GetPR():tmr2GetPR())
#define pwm4SetPS(ps)		((OC4CON1bits.OCTSEL)?tmr3SetPS(ps):tmr2SetPS(ps))
#define pwm4GetPS()			((OC4CON1bits.OCTSEL)?tmr3GetPS():tmr2GetPS())
#endif
...
#else
#define pwm5SetDC(dc)		do {OC5R = (dc);} while (0)
#define pwm5GetDC()			(OC5R)
#define pwm5SetPR(pr)		do {if (OC5CON1bits.OCTSEL) OC5RS = PR3 = (pr) - 1; else OC5RS = PR2 = (pr) - 1;} while (0)
#define pwm5GetPR()			((OC5CON1bits.OCTSEL)?tmr3GetPR():tmr2GetPR())
#define pwm5SetPS(ps)		((OC5CON1bits.OCTSEL)?tmr3SetPS(ps):tmr2SetPS(ps))
#define pwm5GetPS()			((OC5CON1bits.OCTSEL)?tmr3GetPS():tmr2GetPS())
#endif
...
#define ADC_ARAND			ADC_VBG	//the channel for random number generators
...
#define RTCSetYear(dat)			RTCWrite(RTCPTR_YEAR,   (RTCRead(RTCPTR_YEAR  ) & ~0x00ff) | ((dat) & 0x00ff))
 int8_t RTCSetCal( int8_t cal); 	//write to rtcc calibration register, -512 .. +508 RTC pulses every minute, +/- 260ppm adjustments, 2ppm / step
//uint8_t RTCGetCal(void);		//read from rtcc calibration register
#define RTCGetCal()		((int8_t) RCFGCALbits.CAL)
time_t RTC2time(time_t *t);						//turn rtcc to time_t
